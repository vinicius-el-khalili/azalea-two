export const curriculumContent = [
    ...
    },
    {
        ...
        description:"Topological characterization of blood vessels in mouse cortex, using concepts from graph theory, data science, and image processing techniques in Python."
    },
    {
        period:"2020",
        activity:"Consultant",
        place:"Pro Health Solutions ltd.",
        description:"Mathematical modeling and statistical estimations on the economic impact of surgical instrument contamination in hospitals."
    },
    {
        period:"2012-2019",
        activity:"Bachelor's degree in Biomolecular Physics",
        place:"Institute of Physics of São Carlos - University of São Paulo",
        description:"Biomolecular Physics is an interdisciplinary course that bridges the gap between Physics and Molecular Biology. In this course, I learned a variety of topics, including Calculus, Linear Algebra, Classical Mechanics, Thermodynamics, Statistical Physics, Electromagnetism, Biochemistry, Cellular Biology, Organic Chemistry, and Computational Biology."
    },
    {
        period:"2019",
    ...
    },
    {
        ...
        description:`Molecular Sciences is the "secret" course of University of São Paulo, which demands a special selective process outside of the usual entrance exam. It's an interdisciplinary course in which the students learn five big areas: Mathematics, Physics, Chemistry, Biology and Computer Science.`
    },
    {
        period:"2010-2011",
        activity:"Technical degree in Chemistry",
        place:"ETEC Tiquatira",
        description:"In this course, I learned the basics of chemistry and training in laboratory techniques and procedures."
    },
